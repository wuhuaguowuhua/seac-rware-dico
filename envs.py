...
from gym.wrappers.record_video import RecordVideo as Monitor

from stable_baselines3.common.vec_env import DummyVecEnv, SubprocVecEnv, VecEnvWrapper
from stable_baselines3.common.vec_env.vec_video_recorder import VecVideoRecorder
from stable_baselines3.common.vec_env.vec_normalize import VecNormalize as VecNormalize_
from wrappers import TimeLimit, Monitor, SafeReset, FlattenMAObs
...
def make_env(env_id, seed, rank, time_limit, wrappers, monitor_dir):
    def _thunk(rank=0):
        ...
        env = gym.make(env_id, fast_obs=True, msg_bits=1)
